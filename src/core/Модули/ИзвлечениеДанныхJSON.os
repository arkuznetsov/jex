...
// Функция - извлекает данные из JSON-строки, файла или потока по указанному выражению JSON-path
//
// Параметры:
//  ДанныеJSON                     - Строка  - JSON-строка, путь к JSON-файлу или поток
//                                   Поток
//  Путь                           - Строка  - выражение JSON-path для извлечения данных
//  ИзвлекатьЕдинственноеЗначение  - Булево  - Если результирующий массив содержит единственное значение, то:
//                                             Истина -  будет возвращено значение;
//                                             Ложь - будет возвращен массив.
...
//
Функция Выбрать(Знач ДанныеJSON,
	            Знач Путь,
	            ИзвлекатьЕдинственноеЗначение = Истина,
	            JSONКакТекст = Истина,
	            Кодировка = "UTF-8") Экспорт
	...
	Возврат ИзвлечениеДанных.Выбрать(Путь, ИзвлекатьЕдинственноеЗначение, JSONКакТекст);
